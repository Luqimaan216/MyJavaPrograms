...
public class PizzaShop
{
	...
	{
		return "The orders are: " + Arrays.toString(orders);
	}
  ...
  public PizzaShop()
  {
    ...
    Pizza pizza2 = new Pizza("hawain",
        new String[] { "cheese", "tomato", "Halal Turkey ham", "pineapple" }, 6.50);
    ...
    Customer customer4 = new InternetCustomer("Luqmaan Kotwal", "Cross Ormrod Street", "Luqimaan.kotwal@gmail.com");
    Customer customer5 = new InternetCustomer("Morgan Freeman", "Beverly Hills", "Morgan.freeman@gmail.com");
    Customer customer6 = new InternetCustomer("Idris Elba", "Pacific Rim Street", "Idris.elba@gmail.com");
